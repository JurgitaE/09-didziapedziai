...
console.log(`You rolled ${dice[0]} and ${dice[1]}. Total sum is ${dice[0] + dice[1]}, therefore you ${dice[0] + dice[1] > 8 ? 'win' : 'lose'}.`);
...
console.log(`Pilkio svoris yra ${kilos[0]} kg. Murklio svoris yra ${kilos[1]}. ${kilos[0] === kilos[1] ? 'Katinukų svoriai vienodi.' : kilos[0] > kilos[1] ? 'Pilkio svoris didesnis' : 'Murklio svoris didesnis'}`);
